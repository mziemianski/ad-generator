...
function Ensure-RemoteShare {
    ...
    try {
        Log-Operation ("Sprawdzanie katalogu $LocalPath i udziału $ShareName na $FileServer...") "OK" "FILE SERVER"
    ...
    foreach ($groupName in $denyGroups) {
        try {
            ...
            if (-not $group) {
                ...
                Log-Operation ("Grupa " + $groupName + " już istnieje w " + $Install_OU_DN) "OK" "GRUPA"
            }
        }
        catch {
...
function Generate-Users {
    ...
    Log-Operation "Wybrano konwencję nazewniczą dla kont użytkowników: $konwencjaOpis" "OK" "UŻYTKOWNIK"
    ...
    foreach ($dzial in $Dzialy) {
        ...
        try {
            ...
            if (-not $isMember) {
                ...
                Log-Operation "Grupa $groupMain już jest członkiem $groupRW" "OK" "GRUPA"
            }
        }
        catch {
        ...
        try {
            ...
            if (-not $isMember) {
                ...
                Log-Operation "Grupa $groupMain już jest członkiem $groupRW_DZIALY" "OK" "GRUPA"
            }
        }
        ...
        try {
            ...
            if (-not $isMember) {
                ...
                Log-Operation "Grupa $groupMain już jest członkiem $groupRW_OGOLNY" "OK" "GRUPA"
            }
        }
